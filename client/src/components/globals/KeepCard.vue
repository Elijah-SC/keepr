...
<template>
  <div @click="getKeepById()" data-bs-toggle="modal" data-bs-target="#Keep-Modal" class="Parent">
    <img :src="keep.img" alt="keep Img" class="rounded w-100" title="See Keep details">
